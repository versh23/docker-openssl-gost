...
DOCKER_BASE_URL="https://raw.githubusercontent.com/docker-library/php/master/7.3/alpine3.9/fpm"
ORIGINAL_INSTRUCTION="FROM alpine:3.9"
...
FROM test-gost AS openssl-gost
...
sed -i "s|openssl-dev | |g" Dockerfile
sed -i "s|curl-dev | |g" Dockerfile
